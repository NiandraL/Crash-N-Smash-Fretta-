...
surface.CreateFont( "ScoreMedium", {
	font = "Trebuchet MS",
	size = 20,
	weight = 700,
	blursize = 0,
...
surface.CreateFont( "HalfLife2Big", {
	font = "HalfLife2",
	size = 140,
	weight = 400,
	blursize = 0,
...
surface.CreateFont( "InfoSmaller", {
	font = "Arial",
	size = 14,
	weight = 500,
	blursize = 0,
...
function GM:CalcView( pl, origin, angles, fov ) 
	...
	if pl:IsAbsorbed() and IsValid(pl:GetAbsorber()) then
